...
export function DataSources() {
  ...
  return <div className="tab-stack provenance-stack">
    ...
    <section className="surface release-ledger">
      ...
      <div className="release-finding candidate-finding" role="note"><Vote size={17} /><div><strong>Candidate evidence—not official nomination</strong><p>{releaseReadiness.findings.candidateDiscovery.label}, drawn from {releaseReadiness.findings.candidateDiscovery.acceptedRecords} reviewed records across {releaseReadiness.findings.candidateDiscovery.sourceFamilies} official party sources. All {releaseReadiness.findings.candidateDiscovery.councilRegions} Council regions have staged evidence, but six Assembly districts remain uncovered and only the VEC may confer official nomination status.</p></div></div>
