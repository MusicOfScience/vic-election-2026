...
export function DataSources() {
  ...
  return <div className="tab-stack provenance-stack">
    ...
    <section className="surface release-ledger">
      ...
      <div className="release-finding candidate-finding" role="note"><Vote size={17} /><div><strong>Candidate discovery—not acceptance</strong><p>{releaseReadiness.findings.candidateDiscovery.label}, including {releaseReadiness.findings.candidateDiscovery.records} records from {releaseReadiness.findings.candidateDiscovery.sourceFamilies} party sources and {releaseReadiness.findings.candidateDiscovery.councilRegions}/8 Council regions. Accepted Assembly coverage remains {releaseReadiness.findings.candidateDiscovery.acceptedAssemblyContests}/88 until identity, contest and endorsement are explicitly reviewed.</p></div></div>
