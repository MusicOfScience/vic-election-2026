...
The first-party reconstruction in `metadata/historical-poll-reconstruction-evidence.json` now matches 64 of 200 leads to dated observation sources with samples: 33 of 41 Essential leads, 7 of 39 Newspoll leads and 24 of 33 SMS Morgan leads. Forty-one matched observations have explicit method evidence. Eight Essential, 32 Newspoll and nine SMS Morgan leads remain unresolved. Archived matches use capture dates—not self-reported publication dates—as evidence availability dates. The Newspoll PDFs provide random-telephone sampling, weighting, sample and margin-of-error statements, but cumulative historical rows without observation-specific samples remain unresolved. A 2018 Roy Morgan election-eve page also remains unresolved because its archive timestamp falls on 24 November in Melbourne, after the 23 November local cutoff. No identified source declares a formal reusable-data licence; the 200-row lead list therefore remains quarantined, while independently reconstructed factual observations are assessed under the separate three-gate policy. Replay-eligible counts remain zero pending manual promotion. One Newspoll source is an archived contemporaneous mirror of a branded pollster PDF. The May-June 2015 publisher graphic has a cutoff-safe archived article confirming its link and sample, but that capture does not preserve the image binary: its current method text remains corroborating only and is excluded from the verified method count.
