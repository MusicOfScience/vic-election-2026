...
The first-party reconstruction in `metadata/historical-poll-reconstruction-evidence.json` now matches 62 of 200 leads to dated observation sources with samples: 33 of 41 Essential leads, 5 of 39 Newspoll leads and 24 of 33 SMS Morgan leads. Forty matched observations have explicit method evidence. Eight Essential, 34 Newspoll and nine SMS Morgan leads remain unresolved. Archived matches use capture dates—not self-reported publication dates—as evidence availability dates. The Newspoll PDFs provide random-telephone sampling, weighting, sample and margin-of-error statements, but cumulative historical rows without observation-specific samples remain unresolved. A 2018 Roy Morgan election-eve page also remains unresolved because its archive timestamp falls on 24 November in Melbourne, after the 23 November local cutoff. No identified source declares a formal reusable-data licence, so fully reconstructed and replay-eligible counts remain zero and all 200 leads stay quarantined.
