...
| Cutoff-safe ballot and incumbency | Partial | Official VEC 2014, 2018 and 2022 material now fixes nomination and post-draw publication timing frameworks, but candidate-specific acceptance, archived publication timing and aliases remain unresolved | Build cycle-scoped, leakage-safe slate evidence | `npm run validation:evidence` | Open blocker |
