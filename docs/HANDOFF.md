...
- Batch commits: `440c5fe` (implementation) and `47a04a4` (sealed artefacts); PR #104 is open for review: https://github.com/MusicOfScience/vic-election-2026/pull/104
