...
- Publication: PR #108 (`https://github.com/MusicOfScience/vic-election-2026/pull/108`) is merged at `e3e7322d`; this batch is PR #109 (`https://github.com/MusicOfScience/vic-election-2026/pull/109`) on `codex/freeze-2014-holdout`. Local checks are green; GitHub Actions did not start because the account billing/spending limit blocked the runner. Do not merge or deploy manually.
